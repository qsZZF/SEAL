...
% Store converged W (block diagonal sparse matrix)
% W_final_eLORETA = blkdiag(W_iter_blocks{:}); % This creates a large dense matrix
% Instead, store the blocks or use them to construct W_inv
