classdef SEAL_selectAlgorithm < matlab.apps.AppBase
    ...
    panel.Visible = 'on';
        ...
        function prm = fillAlgDefaults(app, algName, prm)
            ...
            if ~isfield(reg, algName) || ~isfield(reg.(algName), 'params')
                return;
            end

            specs = reg.(algName).params;
...
function S = runOneAlgorithm(app, algName, X, L, C, R, Eye_N, nO, prm, toLog)
...
%%
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.SmoothChamNode.NodeData = 'Smooth-Cham';
            ...
            app.FastIRESNode.NodeData = 'Fast-IRES';
            ...
            app.SISTBFNode.NodeData = 'SI-STBF';
